...
<head>
  ...
  <title>Playground — HTML / CSS / JS / Log (完全動作版)</title>
...
<body>
  <div class="topbar">
    <div class="brand">Playground — HTML / CSS / JS / Log</div>
    <div class="controls">
      <button class="action" id="runBtn">Run ▶</button>
      <button class="ghost" id="autoToggle">Auto: ON</button>
      <button id="saveBtn">💾 保存</button>
      <button id="loadBtn">📂 読み込み</button>
      <button id="fullscreenBtn">⛶ フル画面</button>
